...
class QueryRequest(BaseModel):
    ...
    rerank: Optional[bool] = Field(default=None, description="Active/désactive le re-ranking")
...
class QueryResponse(BaseModel):
    ...
    answer: str = Field(..., description="La réponse générée, avec citations [n]")
    ...
    class Config:
        json_schema_extra = {
            "example": {
                "answer": "Le RAG combine retrieval et génération [1].",
                "sources": [
                    {
